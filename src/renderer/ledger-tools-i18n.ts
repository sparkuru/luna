...
const en = {
  ...
  restoreHelp: 'Restore your saved ledger and images from an encrypted backup.',
  mergeHelp: 'Merge a backup of this ledger. Existing history is preserved; backups from another ledger cannot be merged.',
  restoreBackup: 'Restore encrypted backup', confirmRestore: 'I want to restore this backup onto this device.',
  restored: 'Backup restored. Open the ledger to review your records.',
  noConflicts: 'No conflicts. Nothing needs your attention.',
  conflictsHelp: 'Review competing versions and choose the one to keep.',
  loadingConflicts: 'Checking for conflicts…', retry: 'Try again',
  passwordTooLong: 'This password is too long. Shorten it and try again.',
  passwordUnsupported: 'This password contains unsupported characters. Choose another password.',
  ...
  syncPassword: 'Ledger sync password', passwordHelp: 'Use at least 12 characters. Keep this password safe; it cannot be recovered.',
  ...
  importBackup: 'Merge encrypted backup', exported: 'Encrypted backup download started.', saved: 'Encrypted backup saved.', imported: 'Backup merged. Open Conflicts in Settings if any versions need a decision.',
  ...
  passwordError: 'Use a password with at least 12 characters.',
...
const zh: Record<LedgerToolsMessageKey, string> = {
  ...
  mergeHelp: '合并此账本的备份，已有历史会保留；其他账本的备份无法合并。',
  restoreBackup: '恢复加密备份', confirmRestore: '我确认将此备份恢复到这台设备。',
  restored: '备份已恢复，可打开账本查看记录。',
  noConflicts: '没有冲突，无需处理。', conflictsHelp: '检查存在分歧的版本，并选择要保留的版本。',
  loadingConflicts: '正在检查冲突…', retry: '重试',
  passwordTooLong: '密码过长，请缩短后重试。', passwordUnsupported: '密码包含不支持的字符，请更换密码。',
  ...
  syncPassword: '账本同步密码', passwordHelp: '至少 12 个字符。请妥善保管密码，遗失后无法找回。',
  ...
  exported: '已开始下载加密备份。', saved: '加密备份已保存。', imported: '备份已合并，如有版本分歧，请到设置中的冲突处理页面检查。',
